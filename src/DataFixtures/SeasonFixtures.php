...
class SeasonFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $season2022
            ->setId('2022')
            ->setStartsAt(new \DateTimeImmutable('2022-03-20'))
            ->setEndsAt(new \DateTimeImmutable('2022-11-20'))
            ->setRaces(22)
            ->setSprints(3)
        ...
        $season2023
            ->setId('2023')
            ->setStartsAt(new \DateTimeImmutable('2023-03-05'))
            ->setEndsAt(new \DateTimeImmutable('2023-11-26'))
            ->setRaces(23)
            ->setSprints(6)
            ->setCompletedRaces(17)
