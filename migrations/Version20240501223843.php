...
final class Version20240501223843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prediction (id VARCHAR(255) NOT NULL, driver_id VARCHAR DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE race (id VARCHAR(255) NOT NULL, date DATE NOT NULL, completed BOOLEAN NOT NULL, canceled BOOLEAN NOT NULL, full_distance BOOLEAN NOT NULL, sprint_race BOOLEAN NOT NULL, season_id VARCHAR DEFAULT NULL, PRIMARY KEY(id))');
