...
final class Version20240908110933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE circuit (id VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, circuit VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE race (id VARCHAR(255) NOT NULL, date DATE NOT NULL, completed BOOLEAN NOT NULL, canceled BOOLEAN NOT NULL, full_distance BOOLEAN NOT NULL, sprint_race BOOLEAN NOT NULL, grand_prix VARCHAR(255) NOT NULL, season_id VARCHAR DEFAULT NULL, circuit_id VARCHAR DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE race ADD CONSTRAINT FK_DA6FBBAFCF2182C8 FOREIGN KEY (circuit_id) REFERENCES circuit (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
